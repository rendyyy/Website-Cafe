            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    ?>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
                            <?php $tampil1=mysqli_query($koneksi, "select * from po_terima order by id_kon desc");
                    ...
                    ?>
                            <div class="small-box bg-green">
                                ...
                                <a href="pesanan.php" class="small-box-footer">
                                    Lihat Detail Pesanan <span class="glyphicon glyphicon-chevron-right"></span>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                    ...
                    $hasil=mysqli_query($koneksi, $query1) or die(mysqli_error($query));
                    ?>
                  ...
                  <thead>
                    ...
                    <td><a href="detail-produk.php?hal=edit&kd=<?php echo $data['kode'];?>"><span class="glyphicon glyphicon-cutlery"></span> <?php echo $data['nama'];?></td>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="produk.php" class="btn btn-sm btn-primary">Menu Produk<i class="fa fa-arrow-circle-right"></i></a>
                    ...
                    $hasil1=mysqli_query($koneksi, $query2) or die(mysqli_error($query));
                    ?>
                  <table id="example" class="table table-hover table-bordered">
                  <thead>
                      <tr>
                    ...
                    <tr>
                    <td><center><?php echo $no; ?></center></td>
                    <td><center><span class="glyphicon glyphicon-user"></span> <?php echo $data1['username']; ?></center></td>
