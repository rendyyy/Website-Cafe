...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="UPDATE produk SET nama='$nama', jenis='$jenis', harga='$harga', keterangan='$keterangan', stok='$stok', gambar = '$gambar' WHERE kode='$kode'" or die(mysqli_error($query));
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error($query));
           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Foto Terbaru</label>
                              <div class="col-sm-3">
