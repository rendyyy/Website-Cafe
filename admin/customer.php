        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                  ...
                  <thead>
                    ...
                    <td><center><span class="glyphicon glyphicon-user"></span> <?php echo $data['nama_cus']; ?></a></center></td>
                    
                    <td><center>
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['fullname'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus User" href="hapus-user.php?hal=hapus&kd=<?php echo $data['kd_cus'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
