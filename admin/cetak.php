...
$result=mysqli_query($koneksi, "SELECT po_terima.*, konfirmasi.jumlah, produk.kode AS kode_prod, produk.nama, produk.harga, customer.alamat, customer.no_telp, customer.nama_cus AS nama_cus FROM po_terima
				LEFT JOIN produk ON po_terima.kode = produk.kode
				LEFT JOIN customer ON po_terima.kd_cus = customer.kd_cus
                LEFT JOIN konfirmasi ON konfirmasi.id_kon = po_terima.id_kon
				WHERE po_terima.id_kon='$_GET[kd]'") or die(mysqli_error($koneksi));
...
$pdf->Image('../img/home/logo.jpg',10,10,-175);
...
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'CAFE TITIK BEKU',0,0,'C');
$pdf->Ln();
...
$pdf->SetX(5);
$pdf->Cell(80,8,'No: '.$id_kon,0,0,'L',1);
$pdf->SetX(45);
