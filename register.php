	...
	<div id="wrapper">
		...
		<div class="container">
            ...
            include "conn.php";
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM customer WHERE nama_cus='$nama'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO customer (kd_cus, nama_cus, alamat, no_telp, username, password) VALUES ('$kd_cus', '$nama', '$alamat', '$no_telp', '$username', '$password')") or die(mysqli_error($query));
						if($insert){
