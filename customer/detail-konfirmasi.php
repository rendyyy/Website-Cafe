...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                ...
                <?php if($data['bayar_via'] == 'Payment Online'){ ?>
                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Detail Pembayaran" href="pembayaran.php?hal=detail&kd=<?php echo $data['id_kon'];?>">Pembayaran</a>   
                
                <?php } ?> 
                    <a href="index1.php" class="btn btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div> 
              </div>
            </div><!-- col-lg-12--> 
